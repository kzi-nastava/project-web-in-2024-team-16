...
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip) VALUES (2200, true, true, false, '2020-06-12 22:03:48', 1, 5000, 2000, 'tiganj',
                                                          'metalac', 'metalac.jpg', 'FIKSNA');
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip) VALUES (100000, false, false, true, '2019-08-21 19:20:36', 2, 1000, 3000, 'automobil',
                                                          'ford', 'ford.jpg', 'AUKCIJA');
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip) VALUES (4000, false, false, true, '2020-11-28 09:56:24', 3, 5000, 3000, 'akva busilica',
                                                          'bosch', 'bosch.jpg', 'FIKSNA');
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip) VALUES (40000, true, true, false, '2018-03-30 20:13:44', 4, 7000, 2000, 'laptop',
                                                          'lenovo', 'lenovo.jpg', 'FIKSNA');
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip) VALUES (80000, false, false, true, '2019-01-14 16:11:06', 5, 1000, 3000, 'telefon',
...
INSERT INTO Kategorija (id, naziv_kategorije) VALUES (5, 'kuhinja');
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip, kategorija_id) VALUES (2200, true, true, false, '2020-06-12 22:03:48', 1, 5000, 2000, 'tiganj',
                                                          'metalac', 'metalac.jpg', 'FIKSNA', 5);
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip, kategorija_id) VALUES (100000, false, false, true, '2019-08-21 19:20:36', 2, 1000, 3000, 'automobil',
                                                          'ford', 'ford.jpg', 'AUKCIJA', 4);
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip, kategorija_id) VALUES (4000, false, false, true, '2020-11-28 09:56:24', 3, 5000, 3000, 'akva busilica',
                                                          'bosch', 'bosch.jpg', 'FIKSNA',4);
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip, kategorija_id) VALUES (40000, true, true, false, '2018-03-30 20:13:44', 4, 7000, 2000, 'laptop',
                                                          'lenovo', 'lenovo.jpg', 'FIKSNA', 2);
INSERT INTO Proizvod (cena, prodat, recenzija_kupac, recenzija_prodavac, datum_objavljivanja, id, kupac_id, prodavac_id, naziv,
                      opis, slika_proizvoda, tip, kategorija_id) VALUES (80000, false, false, true, '2019-01-14 16:11:06', 5, 1000, 3000, 'telefon',
                                                          'samsung', 'samsung.jpg', 'FIKSNA', 1);
